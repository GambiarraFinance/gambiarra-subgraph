...
export class GambFarm__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class GambFarm extends ethereum.SmartContract {
  static bind(address: Address): GambFarm {
    return new GambFarm("GambFarm", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): GambFarm__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new GambFarm__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<GambFarm__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new GambFarm__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

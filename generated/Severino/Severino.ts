...
export class Severino__poolInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Severino__userInfoResult {
  value0: BigInt;
  value1: BigInt;
...
export class Severino extends ethereum.SmartContract {
  static bind(address: Address): Severino {
    return new Severino("Severino", address);
  }
  ...
  gamb(): Address {
    let result = super.call("gamb", "gamb():(address)", []);

    return result[0].toAddress();
  }

  try_gamb(): ethereum.CallResult<Address> {
    let result = super.tryCall("gamb", "gamb():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  gambPerBlock(): BigInt {
    let result = super.call("gambPerBlock", "gambPerBlock():(uint256)", []);

    return result[0].toBigInt();
  }

  try_gambPerBlock(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("gambPerBlock", "gambPerBlock():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  pendingGamb(_pid: BigInt, _user: Address): BigInt {
    let result = super.call(
      "pendingGamb",
      "pendingGamb(uint256,address):(uint256)",
      [
  ...
  try_pendingGamb(_pid: BigInt, _user: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "pendingGamb",
      "pendingGamb(uint256,address):(uint256)",
      [
  ...
  poolInfo(param0: BigInt): Severino__poolInfoResult {
    let result = super.call(
      "poolInfo",
    ...
    return new Severino__poolInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_poolInfo(param0: BigInt): ethereum.CallResult<Severino__poolInfoResult> {
    let result = super.tryCall(
      "poolInfo",
      "poolInfo(uint256):(address,uint256,uint256,uint256,uint16)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  userInfo(param0: BigInt, param1: Address): Severino__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new Severino__userInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_userInfo(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<Severino__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Severino__userInfoResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
